...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
        ...
        <ul class="menu-inner py-1 overflow-auto">
          ...
          <?php if (session()->get('level') == 'admin') : ?>
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?= site_url('data-kategori'); ?>" class="menu-link">
              ...
              <?php if (session()->get('level') == 'admin') : ?>
                <li class="menu-item">
                  <a href="<?= site_url('data-satuan'); ?>" class="menu-link">
                    <div data-i18n="Without navbar">Satuan</div>
                  </a>
                </li>
              <?php endif; ?>
              ...
              <?php if (session()->get('level') == 'admin') : ?>
                <li class="menu-item">
                  <a href="<?= site_url('data-produk'); ?>" class="menu-link">
        ...
        <li class="menu-item">
          <a href="<?= site_url('login'); ?>" class="menu-link">
        ...
        <li class="menu-item">
          <a href="<?= site_url('data-user') ?>" class="menu-link">
            <i class="menu-icon tf-icons bx bx-cube-alt"></i>
            <div data-i18n="Misc">Pengguna</div>
          </a>
        </li>
      <?php endif; ?>
      <!-- Components -->
      ...
      <?php if (session()->get('level') == 'admin') : ?>
      <li class="menu-item">
        <a href="<?= site_url('data-laporan') ?>" class="menu-link">
          <i class="menu-icon tf-icons bx bx-collection"></i>
        ...
        <footer class="content-footer footer bg-footer-theme">
          <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
            <div class="mb-2 mb-md-0">
              <p>Copyright by :: <span class="fw-bolder">Winda</span></p>
            </div>
            <div>
            </div>
        </footer>
  ...
  <svg id="SvgjsSvg1283" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" style="overflow: hidden; top: -100%; left: -100%; position: absolute; opacity: 0;">
    ...
    <path id="SvgjsPath1286" d="M-1 217.1625L-1 217.1625C-1 217.1625 55.519287109375 217.1625 55.519287109375 217.1625C55.519287109375 217.1625 111.03857421875 217.1625 111.03857421875 217.1625C111.03857421875 217.1625 166.557861328125 217.1625 166.557861328125 217.1625C166.557861328125 217.1625 222.0771484375 217.1625 222.0771484375 217.1625C222.0771484375 217.1625 277.596435546875 217.1625 277.596435546875 217.1625C277.596435546875 217.1625 333.11572265625 217.1625 333.11572265625 217.1625C333.11572265625 217.1625 388.635009765625 217.1625 388.635009765625 217.1625C388.635009765625 217.1625 388.635009765625 217.1625 388.635009765625 217.1625 "></path>
  </svg>
</body>
